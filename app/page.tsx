            ...
            <div className="flex flex-col lg:flex-row items-start">
              <div className="w-full lg:w-1/2 mb-12 lg:mb-0 order-2 lg:order-1">
                <div className="max-w-lg">
                  <h2 className="text-3xl font-bold text-slate-800 mb-6 dark:text-gray-100">Generate Your Web3 Wallet</h2>
                  <p className="text-slate-600 mb-8 dark:text-gray-300">Create a secure wallet in seconds to store your digital assets and connect to decentralized applications. Take control of your crypto journey.</p>
                ...
                <div className="md:hidden w-full px-5">
                  <div className="relative w-full h-64 bg-gradient-to-r from-purple-500 to-purple-700 rounded-xl overflow-hidden shadow-lg">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center flex-col p-4 text-center">
                      <h3 className="text-white text-xl font-semibold mb-2">Mobile Preview</h3>
                      <p className="text-white/80 text-sm">Open on desktop to see the full wallet demo</p>
                    </div>
                  </div>
                </div>
              </div>
